...
This is a fork of the original repository for learning web application development. The original project is covered in Fullstack GPT ([https://www.fullstack-gpt.com/](https://www.fullstack-gpt.com/)).
